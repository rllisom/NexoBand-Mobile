...
class _BandaDetailPageState extends State<BandaDetailPage> {
  ...
  Future<void> _editarFotoPerfil(BuildContext ctx, int bandaId) async {
  ...
  Widget _iconoMusica(double size) => Container(
    width: size,
    height: size,
    decoration: const BoxDecoration(color: Color(0xFF2d2a28)),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        style: const TextStyle(color: Colors.white),
                        decoration: inputDeco('Aforo máximo', hint: 'Opcional'),
  ...
  Future<void> _mostrarAgregarMiembros(BuildContext ctx, int bandaId) async {
    ...
    final banda = await bandaService.getBandaDetail(bandaId);
    final idsMiembros = banda.usuarios.map((u) => u.id).toSet();
              ...
              TextField(
                ...
                onChanged: (q) async {
                  ...
                  try {
                    ...
                    final filtrados = res.where((u) => u.id != usuarioId && !idsMiembros.contains(u.id)).toList();
                    setSheetState(() {
                ...
                ConstrainedBox(
                  ...
                  child: ListView.separated(
                    ...
                    separatorBuilder: (_, __) =>
                        const Divider(color: Color(0xFF2E2C2A), height: 1),
                    itemBuilder: (_, i) {
                        ...
                        trailing: isAdding
                            ...
                            : TextButton(
                                ...
                                onPressed: () async {
                                  ...
                                  final bandaBloc = ctx.read<BandaBloc>();
                                  final messenger = ScaffoldMessenger.of(ctx);
                                  try {
                                    await bandaService.agregarMiembro(
                                      bandaId,
                                      u.id,
                                    );
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (_) =>
              BandaBloc(bandaService: bandaService)
                ..add(LoadBandaDetail(widget.banda.id)),
        ),
        BlocProvider(
          create: (_) => PublicacionBloc(
            PublicacionService(),
            ComentarioService(),
            PublicidadService(),
          ),
                      ...
                      actions: [
                        ...
                        TextButton(
                          onPressed: () async {
                            ...
                            try {
                              final banda = await bandaService.getBandaDetail(
                                widget.banda.id,
                              );
                              for (final usuario in banda.usuarios) {
                                try {
                                  await bandaService.eliminarMiembro(
                                    widget.banda.id,
                                    usuario.id,
                                  );
                                } catch (e) {
                                  if (mounted) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'Error al desasociar ${usuario.nombre}: $e',
                                        ),
                                        backgroundColor: const Color(
                                          0xFFef365b,
                                        ),
                              ...
                              final user = await perfilService.getUsuario(
                                userId,
                              );
                              ...
                              if (mounted) {
                                Navigator.pushReplacement(
                                  ...
                                  MaterialPageRoute(
                                    builder: (_) =>
                                        BandasUsuarioPage(bandas: user.bandas),
                                  ),
                                );
                              }
                            } catch (e) {
                ...
                if (state is BandaDetailLoaded || state is BandaFotoSubiendo) {
                  final b = state is BandaDetailLoaded
                      ...
                      : (context.read<BandaBloc>().state is BandaDetailLoaded
                            ? (context.read<BandaBloc>().state
                                      as BandaDetailLoaded)
                                  .banda
                            : null);
                                ...
                                Padding(
                                  ...
                                  child: Align(
                                    ...
                                    child: OutlinedButton.icon(
                                      ...
                                      onPressed: () =>
                                          _abrirCrearPublicacion(context, b.id),
                                      icon: const Icon(
                                        Icons.add,
                                        size: 17,
                                        color: Color(0xFFFC7E39),
                                ...
                                Padding(
                                  ...
                                  child: Align(
                                    ...
                                    child: OutlinedButton.icon(
                                      ...
                                      onPressed: () => _mostrarAgregarMiembros(
                                        context,
                                        b.id,
                                      ),
                                      icon: const Icon(
                                ...
                                Expanded(
                                  child: b.usuarios.isEmpty
                                      ...
                                      : ListView.separated(
                                          ...
                                          separatorBuilder: (_, __) =>
                                              const SizedBox(height: 8),
                                          itemBuilder: (_, i) => MiembroCard(
                                            miembro: b.usuarios[i],
                                            bandaId: b.id,
                                          ),
                                        ),
                                ),
                                ...
                                Padding(
                                  ...
                                  child: Align(
                                    ...
                                    child: OutlinedButton.icon(
                                      ...
                                      onPressed: () =>
                                          _mostrarCrearEvento(context, b.id),
                                      icon: const Icon(
                                        Icons.add,
                                        size: 17,
                                        color: Color(0xFFFC7E39),
